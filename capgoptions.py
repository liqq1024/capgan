...
class Options():
    ...
    def __init__(self):
        ...
        #capg arguments
        #normaly_s: str, anomaly_slist: list, num_train:int, num_normaly:int, num_anormaly:int
        self.parser.add_argument('--normaly_s', default=1, help='18 subjects from 1 to 18')
        self.parser.add_argument('--anomaly_slist', default=[2], help='anormaly subjects list from 1 to 18 except normaly_s, can be multiple choice')
        self.parser.add_argument('--num_train', default=80000, help='frames of train set, max = 82000')
        self.parser.add_argument('--num_normaly', default=10000, help='test frames from normaly subject, max = 82000')
        self.parser.add_argument('--num_anormaly', default=10000, help='test frames from anormaly subject, max = 82000*17')
    ##
    ##
        # Base
        self.parser.add_argument('--dataset', default='capg', help='folder | cifar10 | mnist |capg')
        ...
        self.parser.add_argument('--isize', type=int, default=16, help='input image xsize.')
        #self.parser.add_argument('--yisize', type=int, default=8, help='input image ysize.')
        ...
        self.parser.add_argument('--abnormal_class', default='001', help='Anomaly class idx for mnist and cifar datasets')
