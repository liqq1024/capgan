...
from lib_capg.capgnetworks import NetG, NetD, weights_init
from lib_capg.capgvisualizer import Visualizer
from lib_capg.capgloss import l2_loss
from lib_capg.capgevaluate import evaluate
...
class Ganomaly(BaseModel):
    ...
    def __init__(self, opt, dataloader):
        ...
        summary(self.netg,(1,16,8))
        summary(self.netd,(1,16,8))
        #print(self.netg)
        #print(self.netd)
